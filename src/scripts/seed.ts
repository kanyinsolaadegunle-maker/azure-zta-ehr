  ...
  try {
    ...
    const mockUsers = [
      ...
      },
      {
        ...
        displayName: 'Dr. Emily Carson, MD',
        description: 'doctor01',
        projectMeaning: 'Primary Care Physician - General Practice (Panel: PR-2024-00142, PR-2026-00201)',
      ...
      },
      {
        id: 'u-doctor02',
        username: 'doctor02',
        email: 'doctor02@hallmarkmedical.com',
        password: 'DoctorPass2026!',
        displayName: 'Dr. Marcus Vance, MD',
        description: 'doctor02',
        projectMeaning: 'Attending Physician - Cardiology & Internal Med (Panel: PR-2026-00202, PR-2026-00203)',
      ...
      },
      {
        id: 'u-doctor03',
        username: 'doctor03',
        email: 'doctor03@hallmarkmedical.com',
        password: 'DoctorPass2026!',
        displayName: 'Dr. Elena Rostova, MD',
        description: 'doctor03',
        projectMeaning: 'Attending Physician - Neurology & Critical Care (Panel: PR-2026-00204, PR-2026-00205)',
      ...
      },
      {
        ...
        email: 'patient.john@hallmarkmedical.com',
        password: 'PatientPass2026!',
        displayName: 'John A. Williams',
        description: 'patient.john',
        projectMeaning: 'Patient Account (PR-2024-00142)',
        avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=patient.john',
        status: 'Active',
      },
      {
        id: 'u-patientsophia',
        username: 'patient.sophia',
        email: 'patient.sophia@hallmarkmedical.com',
        password: 'PatientPass2026!',
        displayName: 'Sophia R. Martinez',
        description: 'patient.sophia',
        projectMeaning: 'Patient Account (PR-2026-00201)',
        avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=patient.sophia',
        status: 'Active',
      },
    ...
    const userGroupMappings = [
      ...
      { userId: 'u-doctor02', groupId: 'g-doctors' },
      { userId: 'u-doctor03', groupId: 'g-doctors' },
