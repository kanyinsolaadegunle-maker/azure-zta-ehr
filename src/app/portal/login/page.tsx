...
const defaultFallbackUsers = [
  ...
  { id: 'u-doctor01', username: 'doctor01', password: 'DoctorPass2026!', displayName: 'Doctor User', description: 'doctor01', projectMeaning: 'Clinical user who requires access to patient records', avatarUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Doctors', userGroups: [{ group: { id: 'g-doctors', name: 'EHR-Doctors' } }] },
  ...
  { id: 'u-recordsadmin01', username: 'recordsadmin01', password: 'RecordsAdmin2026!', displayName: 'Records Admin User', description: 'recordsadmin01', projectMeaning: 'Administrative user for non-clinical records', avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Records-Admins', userGroups: [{ group: { id: 'g-records', name: 'EHR-Records-Admins' } }] },
