...
const defaultFallbackUsers = [
  { id: 'u-globaladmin01', username: 'globaladmin01', password: 'GlobalMasterAdmin2026!', displayName: 'Global Master Administrator', description: 'globaladmin01', projectMeaning: 'Master Administrator with unrestricted global access across all EHR modules and Azure configuration', avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Cloud-Admins', userGroups: [{ group: { id: 'g-admins', name: 'EHR-Cloud-Admins' } }] },
  { id: 'u-doctor01', username: 'doctor01', password: 'DoctorPass2026!', displayName: 'Dr. Emily Carson, MD', description: 'doctor01', projectMeaning: 'Primary Care Physician - General Practice', avatarUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Doctors', userGroups: [{ group: { id: 'g-doctors', name: 'EHR-Doctors' } }] },
  { id: 'u-doctor02', username: 'doctor02', password: 'DoctorPass2026!', displayName: 'Dr. Marcus Vance, MD', description: 'doctor02', projectMeaning: 'Attending Physician - Cardiology & Internal Medicine', avatarUrl: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Doctors', userGroups: [{ group: { id: 'g-doctors', name: 'EHR-Doctors' } }] },
  { id: 'u-doctor03', username: 'doctor03', password: 'DoctorPass2026!', displayName: 'Dr. Elena Rostova, MD', description: 'doctor03', projectMeaning: 'Attending Physician - Neurology & Critical Care', avatarUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Doctors', userGroups: [{ group: { id: 'g-doctors', name: 'EHR-Doctors' } }] },
  { id: 'u-patientjohn', username: 'patient.john', password: 'PatientPass2026!', displayName: 'John A. Williams', description: 'patient.john', projectMeaning: 'Patient Account (PR-2024-00142)', avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=patient.john', status: 'Active', groupName: 'Patient-Self-Service', userGroups: [] },
  { id: 'u-patientsophia', username: 'patient.sophia', password: 'PatientPass2026!', displayName: 'Sophia R. Martinez', description: 'patient.sophia', projectMeaning: 'Patient Account (PR-2026-00201)', avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=patient.sophia', status: 'Active', groupName: 'Patient-Self-Service', userGroups: [] },
  { id: 'u-nurse01', username: 'nurse01', password: 'NursePass2026!', displayName: 'Nurse User', description: 'nurse01', projectMeaning: 'Clinical user with limited patient-care access', avatarUrl: 'https://images.unsplash.com/photo-1594824813566-7885a65c9172?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Nurses', userGroups: [{ group: { id: 'g-nurses', name: 'EHR-Nurses' } }] },
  { id: 'u-recordsadmin01', username: 'recordsadmin01', password: 'RecordsAdmin2026!', displayName: 'Records Admin User', description: 'recordsadmin01', projectMeaning: 'Administrative user for non-clinical records & patient-doctor panel assignment', avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Records-Admins', userGroups: [{ group: { id: 'g-records', name: 'EHR-Records-Admins' } }] },
  { id: 'u-itsecurityadmin01', username: 'itsecurityadmin01', password: 'SecurityAdmin2026#', displayName: 'IT Security Admin User', description: 'itsecurityadmin01', projectMeaning: 'Security monitoring and incident response user (Super Admin)', avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-IT-Security', userGroups: [{ group: { id: 'g-security', name: 'EHR-IT-Security' } }] },
  { id: 'u-cloudadmin01', username: 'cloudadmin01', password: 'CloudAdmin2026#', displayName: 'Cloud Admin User', description: 'cloudadmin01', projectMeaning: 'Cloud resource management user (Super Admin)', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Cloud-Admins', userGroups: [{ group: { id: 'g-admins', name: 'EHR-Cloud-Admins' } }] },
  { id: 'u-vendor01', username: 'vendor01', password: 'VendorPass2026!', displayName: 'Vendor User', description: 'vendor01', projectMeaning: 'Third-party vendor with restricted technical access', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Vendors', userGroups: [{ group: { id: 'g-vendors', name: 'EHR-Vendors' } }] },
  { id: 'u-auditor01', username: 'auditor01', password: 'AuditorPass2026!', displayName: 'Auditor User', description: 'auditor01', projectMeaning: 'Compliance auditor for access log review', avatarUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=256&q=80', status: 'Active', groupName: 'EHR-Auditors', userGroups: [{ group: { id: 'g-auditors', name: 'EHR-Auditors' } }] },
  { id: 'u-emergencyadmin', username: 'emergency.admin', password: 'BreakGlassPass2026!', displayName: 'Emergency Break-Glass Admin', description: 'emergency.admin', projectMeaning: 'Break-glass administrative override account', avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=emergency.admin', status: 'Active', groupName: 'None (Break-glass)', userGroups: [] },
];
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-r from-slate-900 via-slate-900 to-blue-950/30">
          <div>
            ...
            <p className="text-slate-400 text-xs mt-1">
              Hallmark Directory, Security Groups & User Management
            </p>
          </div>
