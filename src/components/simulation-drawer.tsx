...
const mockUsersList = [
  ...
  { username: 'doctor01', label: '🩺 Dr. Emily Carson (doctor01)', meaning: 'Primary Care Physician - General Practice (Panel: PR-2024-00142, PR-2026-00201)', group: 'EHR-Doctors' },
  { username: 'doctor02', label: '🩺 Dr. Marcus Vance (doctor02)', meaning: 'Attending Physician - Cardiology & Internal Med (Panel: PR-2026-00202, PR-2026-00203)', group: 'EHR-Doctors' },
  { username: 'doctor03', label: '🩺 Dr. Elena Rostova (doctor03)', meaning: 'Attending Physician - Neurology & Critical Care (Panel: PR-2026-00204, PR-2026-00205)', group: 'EHR-Doctors' },
  { username: 'nurse01', label: 'Nurse User (nurse01)', meaning: 'Clinical user with limited patient-care access (Read-Only)', group: 'EHR-Nurses' },
  { username: 'recordsadmin01', label: 'Records Admin User (recordsadmin01)', meaning: 'Administrative user for non-clinical records & patient-doctor panel assignment', group: 'EHR-Records-Admins' },
  { username: 'patient.john', label: '👤 John A. Williams (patient.john)', meaning: 'Patient Account (PR-2024-00142) - Read-Only Patient Portal', group: 'Patient-Self-Service' },
  { username: 'patient.sophia', label: '👤 Sophia R. Martinez (patient.sophia)', meaning: 'Patient Account (PR-2026-00201) - Read-Only Patient Portal', group: 'Patient-Self-Service' },
  { username: 'patient.robert', label: '👤 Robert T. Chen (patient.robert)', meaning: 'Patient Account (PR-2026-00202) - Read-Only Patient Portal', group: 'Patient-Self-Service' },
  { username: 'patient.amara', label: '👤 Amara K. Okafor (patient.amara)', meaning: 'Patient Account (PR-2026-00203) - Read-Only Patient Portal', group: 'Patient-Self-Service' },
  { username: 'patient.david', label: '👤 David L. Miller (patient.david)', meaning: 'Patient Account (PR-2026-00204) - Read-Only Patient Portal', group: 'Patient-Self-Service' },
  { username: 'patient.emily', label: '👤 Emily J. Watson (patient.emily)', meaning: 'Patient Account (PR-2026-00205) - Read-Only Patient Portal', group: 'Patient-Self-Service' },
